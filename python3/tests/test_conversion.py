...
class MySQLConverterTests(tests.MySQLConnectorTests):
    ...
    def test__datetime_to_mysql(self):
        ...
        data = datetime.datetime(2008, 5, 7, 20, 0o1, 23)
        res = self.cnv._datetime_to_mysql(data)
        exp = data.strftime('%Y-%m-%d %H:%M:%S').encode('ascii')
    ...
    def test__time_to_mysql(self):
        ...
        data = datetime.time(20, 0o3, 23)
        res = self.cnv._time_to_mysql(data)
        exp = data.strftime('%H:%M:%S').encode('ascii')
    ...
    def test__timedelta_to_mysql(self):
        ...
        self.assertEqual(b'40:30:12', self.cnv._timedelta_to_mysql(data1))
        self.assertEqual(b'-40:30:12', self.cnv._timedelta_to_mysql(data2))
        self.assertEqual(b'39:59:12', self.cnv._timedelta_to_mysql(data3))
        self.assertEqual(b'-39:00:12', self.cnv._timedelta_to_mysql(data4))
    ...
    def test__DATETIME_to_python(self):
        ...
        data = b'2008-05-07 22:34:10'
        exp = datetime.datetime(2008, 5, 7, 22, 34, 10)
        res = self.cnv._DATETIME_to_python(data)

        self.assertEqual(exp, res)
        
        res = self.cnv._DATETIME_to_python(b'0000-00-00 00:00:00')
        self.assertEqual(None, res)
        res = self.cnv._DATETIME_to_python(b'1000-00-00 00:00:00')
        self.assertEqual(None, res)
